...
@export var recording_audio: AudioStreamPlayer
...
func start_recording():
	...
	is_recording = true
	if recording_audio:
		recording_audio.pitch_scale = pitch_min
...
func _process(delta: float) -> void:
	...
	if is_recording:
		...
		if recording_audio:
			if !recording_audio.playing: recording_audio.playing = true
			recording_audio.pitch_scale = lerp(pitch_min, pitch_max, progress_ratio)
	else:
